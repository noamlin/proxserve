...
function $431788524d5470e1$export$af0f09151be4a419(dataNode, change, logLevel) {
    ...
    if (change.type === (0, $cebd7357bd8525a2$export$fa3d5b535a2458a1).shift || change.type === (0, $cebd7357bd8525a2$export$fa3d5b535a2458a1).unshift) verb += "ed";
    else verb += "d";
...
class $643fcf18b2d2e76f$export$d402cf8388053971 {
	 ...
	 */ static createProxy(metadata, parentDataNode, targetProperty) {
        ...
        const target = proxyNode[0, $cebd7357bd8525a2$export$f7e0aa381a5261fc].target;
        const typeoftarget = (0, $c0486756bd3a8c4d$export$99a2acdf670c1bf4)(target);
            ...
            const revocable = Proxy.revocable(target, {
                ...
                deleteProperty: (target /*same as parent scope 'target'*/ , property)=>{
                    ...
                    if (property in target) {
                        ...
                        (0, $590092d9df4e6b38$export$febbc75e71f4ca1b)(dataNode, property, oldValue, isOldValueProxy, undefined, false, metadata.trace);
                        return true;
