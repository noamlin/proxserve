...
var $cebd7357bd8525a2$export$4a2e650c134b86af;
(function(eventNames) {
...
})($cebd7357bd8525a2$export$4a2e650c134b86af || ($cebd7357bd8525a2$export$4a2e650c134b86af = {
}));
...
function $431788524d5470e1$export$953dd193a01bd6ec(parentDataNode, parentProxyNode, property, target) {
...
$parcel$export($f6f254486f25c78f$exports, "getProxserveInstance", function () { return $f6f254486f25c78f$export$8caee43385408ac4; });
...
"use strict";
function $f6f254486f25c78f$export$fa6813432f753b0d(dataNode) {
    dataNode[$cebd7357bd8525a2$export$d1c20e4ad7d32581].status = $cebd7357bd8525a2$export$eb0c55c6f2ee7170.STOPPED;
}
function $f6f254486f25c78f$export$837bd02682cd3db9(dataNode) {
    dataNode[$cebd7357bd8525a2$export$d1c20e4ad7d32581].status = $cebd7357bd8525a2$export$eb0c55c6f2ee7170.BLOCKED;
}
function $f6f254486f25c78f$export$234c45b355edd85b(dataNode, proxyNode, force = false) {
    if (force || dataNode === this.dataTree) dataNode[$cebd7357bd8525a2$export$d1c20e4ad7d32581].status = $cebd7357bd8525a2$export$eb0c55c6f2ee7170.ACTIVE;
    else delete dataNode[$cebd7357bd8525a2$export$d1c20e4ad7d32581].status;
}
function $f6f254486f25c78f$export$af631764ddc44097(dataNode, proxyNode, events, path, listener, options) {
    let { deep: deep = false , id: id , once: once = false  } = options;
    if (events === 'change') events = Object.keys($cebd7357bd8525a2$export$4a2e650c134b86af); // will listen to all events
    else if (!Array.isArray(events)) events = [
        events
    ];
    for (let event of events)if (!$cebd7357bd8525a2$export$4a2e650c134b86af[event]) {
        const names = Object.keys($cebd7357bd8525a2$export$4a2e650c134b86af);
    ...
    for (let property of segments){
        if (!dataNode[property]) $431788524d5470e1$export$953dd193a01bd6ec(dataNode, undefined, property, undefined);
        dataNode = dataNode[property];
    }
    let listenersPool = dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].listeners.shallow;
    if (deep) listenersPool = dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].listeners.deep;
    let listenerObj = {
        type: events,
        once: once,
        func: listener
...
function $f6f254486f25c78f$export$d2de3aaeafa91619(dataNode, proxyNode, events, path, listener, options) {
    if (typeof options !== 'object') options = {
    };
    options.once = true;
    $f6f254486f25c78f$export$af631764ddc44097.call(this, dataNode, proxyNode, events, path, listener, options);
}
...
function $f6f254486f25c78f$export$b03e9483f936dccb(dataNode, proxyNode, path, id) {
    if (arguments.length === 3) {
        id = path;
        path = '';
    }
    let fullPath = `${dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].path}${path}`;
    let segments = $c0486756bd3a8c4d$export$824c337f43f2b64d(path);
...
function $f6f254486f25c78f$export$6f2e3a6079f109b1(dataNode, proxyNode, path = '') {
    let fullPath = `${dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].path}${path}`;
    let segments = $c0486756bd3a8c4d$export$824c337f43f2b64d(path);
    //traverse down the tree
    for (let property of segments){
...
function $f6f254486f25c78f$export$35f261dd63190ac1(dataNode, proxyNode) {
    return proxyNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].target;
}
function $f6f254486f25c78f$export$c3c6db5039118967(dataNode, proxyNode) {
    return {
        dataNode: dataNode,
        proxyNode: proxyNode
    };
}
function $f6f254486f25c78f$export$8caee43385408ac4() {
    return this;
}
 ...
 */ function $590092d9df4e6b38$var$getProxyValue(dataNode, property) {
    if (dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxyNode && dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxyNode[$cebd7357bd8525a2$export$d1c20e4ad7d32581].status === $cebd7357bd8525a2$export$89e04a1d3d3065f6.ALIVE) return dataNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxyNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxy; // actual proxy of child node
        ...
        if (parentNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxyNode && parentNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxyNode[$cebd7357bd8525a2$export$d1c20e4ad7d32581].status === $cebd7357bd8525a2$export$89e04a1d3d3065f6.ALIVE) return parentNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxyNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxy[property]; // proxy or primitive via parent's proxy object
    }
    return undefined;
}
function $590092d9df4e6b38$export$febbc75e71f4ca1b(dataNode, property, oldValue, wasOldValueProxy, value, isValueProxy) {
    ...
    let changeType = $cebd7357bd8525a2$export$4a2e650c134b86af.update;
    if (value === undefined) changeType = $cebd7357bd8525a2$export$4a2e650c134b86af.delete;
    else if (oldValue === undefined) changeType = $cebd7357bd8525a2$export$4a2e650c134b86af.create;
    let deferredEvents;
 ...
 */ function $590092d9df4e6b38$var$captureEmit(dataNode, change) {
    ...
    for (let key of keys){
        ...
        if (subValue !== subOldValue) {
            let changeType = $cebd7357bd8525a2$export$4a2e650c134b86af.update;
            if (subValue === undefined) changeType = $cebd7357bd8525a2$export$4a2e650c134b86af.delete;
            else if (subOldValue === undefined) changeType = $cebd7357bd8525a2$export$4a2e650c134b86af.create;
            let subChange = {
                path: '',
...
function $26afb3b451fe81b5$export$869882364835d202(dataNode, proxyNode, start, deleteCount, ...items) {
    ...
    $590092d9df4e6b38$export$29f2d3a310653bb4(dataNode, $cebd7357bd8525a2$export$4a2e650c134b86af.splice, args, oldValue, proxyNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].target);
    return deleted;
}
function $26afb3b451fe81b5$export$fba63a578e423eb(dataNode, proxyNode) {
    ...
    $590092d9df4e6b38$export$29f2d3a310653bb4(dataNode, $cebd7357bd8525a2$export$4a2e650c134b86af.shift, {
...
function $26afb3b451fe81b5$export$37cdb546b806ae87(dataNode, proxyNode, ...items) {
    ...
    $590092d9df4e6b38$export$29f2d3a310653bb4(dataNode, $cebd7357bd8525a2$export$4a2e650c134b86af.unshift, args, oldValue, proxyNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].target);
    return newLength;
}
...
class $643fcf18b2d2e76f$export$d402cf8388053971 {
	 ...
	 */ createProxy(parentDataNode, targetProperty) {
        ...
        if (targetProperty === undefined) {
            ...
            const newNodes = $431788524d5470e1$export$953dd193a01bd6ec(parentDataNode, parentProxyNode, targetProperty, parentProxyNode[$cebd7357bd8525a2$export$f7e0aa381a5261fc].target[targetProperty]);
        ...
        if ($cebd7357bd8525a2$export$94b8be4ec3303efd[typeoftarget]) {
            let revocable = Proxy.revocable(target1, {
                get: (target /*same as parent scope 'target'*/ , property, proxy)=>{
                    if (this.emitMethods && Object.prototype.hasOwnProperty.call($26afb3b451fe81b5$exports, property) && property in Object.getPrototypeOf(target)) // use a proxy method instead of the built-in method that is on the prototype chain
                    return $26afb3b451fe81b5$exports[property].bind(this, dataNode, proxyNode);
                    ...
                    return $f6f254486f25c78f$exports[property].bind(this, dataNode, proxyNode);
                ...
                set: (target /*same as parent scope 'target'*/ , property, value, proxy)=>{
                    ...
                    if (proxyNode[property] !== undefined && proxyNode[property][$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxy !== undefined) {
                        ...
                        setTimeout($643fcf18b2d2e76f$export$d402cf8388053971.destroy, this.destroyDelay, proxyNode[property][$cebd7357bd8525a2$export$f7e0aa381a5261fc].proxy);
                    }
            ...
            if ($cebd7357bd8525a2$export$94b8be4ec3303efd[typeoftarget]) {
                ...
                for (let key of keys){
                    ...
                    if ($cebd7357bd8525a2$export$94b8be4ec3303efd[typeofproperty]) this.createProxy(dataNode, key); //recursively make child objects also proxies
                }
	 ...
	 */ constructor(target, options = {
        ...
        const newNodes = $431788524d5470e1$export$953dd193a01bd6ec(dataTreePrototype, proxyTreePrototype, '', target);
